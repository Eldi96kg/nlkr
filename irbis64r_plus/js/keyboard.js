 ...
 *
 */
//var VKI_attach, VKI_close;                                           // sokv
var VKI_attach, VKI_close, VKI_show_on_click;                          // sokv
(function() {
  var self = this;

  VKI_show_on_click = true;  //                                                            // sokv
  ...
  //this.VKI_imageURI = "keyboard.png";  // If empty string, use imageless mode                 // sokv
  this.VKI_imageURI = "";  // If empty string, use imageless mode                               // sokv
  ...
  VKI_attach = function(elem) {
    ...
    if (self.VKI_imageURI) {
      ...
      elem.onfocus = function() {
        if (!VKI_show_on_click) return;   // sokv
